<?php
namespace Mknooihuisen\LaravelFusionauth\Console;
...
trait InstallsInertiaStacks
{
    ...
    protected function installInertiaVueStack()
    {
        ...
        $this->info('FusionAuth scaffolding installed successfully.');
    ...
    {
        $this->warn("Inertia with React is not currently supported.");
        return;
